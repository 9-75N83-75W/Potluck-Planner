...
//     // Define the categories to match the backend schema
//     const categories = [
...
//             console.log("accessToken from localStorage:", user.accessToken);
...
//                 const constraints = formData[key].hasConstraint === "yes"
//                     ? formData[key].details.split(",").map((item) => item.trim()).filter(Boolean)
//                     : [];
...
//                         if (!res.ok) throw new Error(data.error || `Failed updating ${key}`);
//                         console.log(`${key} updated:`, data);
//                         return data;
//                     } catch {
//                         console.error(`Unexpected response for ${key}:`, text);
//                         throw new Error(`Server returned invalid JSON for ${key}`);
//                     }
//                 });
//             });
